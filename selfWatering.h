...
#if ((CHANNEL_COUNT == 0) || (CHANNEL_COUNT > 5))
#error "Количество каналов должно быть задано в пределах 1 - 5"
#endif

// ==== настройки ====================================
#define FIRMWARE_VERSION "5.3.1"       // версия прошивки
...
4 коротких + 1 длинный - сброс счетчика пройденных шестичасовых циклов
