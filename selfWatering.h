...
#define SNS_RESCAN 4   // состояние повторного измерения, датчик включен
...
struct ChannelData
{
  ...
  byte metering_flag; // состояние датчика: SNS_NONE, SNS_METERING, SNS_WATERING, SNS_TESTING, SNS_RESCAN
